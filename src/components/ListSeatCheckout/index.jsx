    ...
    return (
       <div className="list__seat">
           ...
           <div  className={activeClass || "list__seat__item"}>
               <button className="list__seat__item__btn" disabled={disableButton(activeClass)} onClick={props.onClick }><span className="list__seat__item__btn__tittle ">{tenGhe || "1"}</span></button>
           </div>
