...
export default function ChangeThePasswordUser() {
    ...
    const formik = useFormik({
        ...
        validate:values =>{
            ...
            if (!values.matKhauCu) {
                 errors.matKhauCu = "Bạn chưa nhập mật khẩu củ"
            }else if(values.matKhauCu !== matKhau){
                errors.matKhauCu = "Bạn khẩu không chính sác !"
            }
            ...
            if(!values.matKhauMoi){
                ...
                errors.matKhauMoi = "Độ dại mật khẩu mới phải nhiều hớn 5 kí tự"
            }
            

            if(!values.nhapLaiMatKhauMoi){
                errors.nhapLaiMatKhauMoi = "Bạn chưa nhập nhập lại mật khẩu mới"
      ...
      <div className="change__password__form">
        <form    onSubmit={formik.handleSubmit}>
          ...
          <div className="form-group">
            <label htmlFor="matkhaucu">Mật khẩu củ :</label>
            <input
              type="password"
            ...
            />
              {formik.errors.matKhauCu ? <div className="alert-danger mt-1 text-center">{formik.errors.matKhauCu}</div> : null}
          </div>
          <div className="form-group">
            ...
            />
              {formik.errors.matKhauMoi ? <div className="alert-danger mt-1 text-center">{formik.errors.matKhauMoi}</div> : null}
          </div>
          ...
          <div className="form-group">
            ...
            />
              {formik.errors.nhapLaiMatKhauMoi ? <div className="alert-danger mt-1 text-center">{formik.errors.nhapLaiMatKhauMoi}</div> : null}
          </div>
